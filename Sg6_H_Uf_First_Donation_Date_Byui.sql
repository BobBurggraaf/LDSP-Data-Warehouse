/****************************************************
	...
	Name: Ldsp_First_Donation_Date_Byui
	Date: 01/20/2018
	
	This Table-valued Function returns a table with the date of the first donation given to BYUI by a donor.
...
GO
/****** Object:  UserDefinedFunction [dbo].[Ldsp_First_Donation_Date_Byui]    Script Date: 1/20/2018 1:51:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER FUNCTION [dbo].[Ldsp_First_Donation_Date_Byui]()
			RETURNS TABLE
			AS 
			RETURN
				SELECT A.Donor_Key
