/****************************************************
	...
	This function is used to proper case a field.
	You can put in strings that would be excluded and
	you can say which stings by length will automatically be capitalized.
...
GO
/****** Object:  UserDefinedFunction [dbo].[ufProperCase]    Script Date: 1/20/2018 2:36:57 PM ******/
SET ANSI_NULLS ON
GO
